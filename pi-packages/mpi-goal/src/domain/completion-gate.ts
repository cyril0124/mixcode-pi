...
import { buildFloorCompletionRefusal, selectFloorWorkCard, type FloorWorkCard } from "./floor-steering.js";
...
export function decideGoalCompletion(input: GoalCompletionGateInput): CompletionDecision {
	...
	const selected =
		card ?? selectFloorWorkCard({ goal: input.currentGoal, telemetry: null, floor });
