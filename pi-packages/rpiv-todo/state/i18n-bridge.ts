...
try {
	// Indirect specifier: `@juicesharp/rpiv-i18n` is an optional peer not
	// installed in this tree; the catch below is the runtime contract for its
	// absence (identity passthrough returning the English fallback).
	const i18nSpecifier = "@juicesharp/rpiv-i18n";
