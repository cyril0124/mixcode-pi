...
export const MIXCODE_DARK_THEME: MixCodeTheme = {
  ...
  activeTab: (text: string) => `${bgRgb("#8abeb7")(rgb("#18181e")(text))}`,
...
export const CLAUDE_WARM_THEME: MixCodeTheme = {
  ...
  activeTab: (text: string) => `${bgRgb("#f0c674")(rgb("#141413")(text))}`,
...
export const TOKYO_NIGHT_THEME: MixCodeTheme = {
  ...
  activeTab: (text: string) => `${bgRgb("#7dcfff")(rgb("#1a1b26")(text))}`,
