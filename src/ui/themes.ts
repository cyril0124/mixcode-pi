...
export const MIXCODE_DARK_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#5f87ff"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#505050"),
  thinkingText: rgb("#808080"),
  thinkingMax: rgb("#d183e8"),
...
export const CLAUDE_WARM_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#d97757"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#3d3d3a"),
  thinkingText: rgb("#87867f"),
  thinkingMax: rgb("#a63d20"),
...
export const TOKYO_NIGHT_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#7aa2f7"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#3b4261"),
  thinkingText: rgb("#66709c"),
  thinkingMax: rgb("#f7768e"),
...
export const TERMINAL_THEME: MixCodeTheme = {
  ...
  searchMatchBg: (text: string) => `\x1b[7m${text}\x1b[27m`,
  searchMatchText: identity,
  scrollbarThumb: dim,
  thinkingText: dim,
  thinkingMax: ansiMagenta,
...
export const CATPPUCCIN_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#89b4fa"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#45475a"),
  thinkingText: rgb("#6c7086"),
  thinkingMax: rgb("#f38ba8"),
...
export const KANAGAWA_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#7E9CD8"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#2A2A37"),
  thinkingText: rgb("#727169"),
  thinkingMax: rgb("#FF5D62"),
...
export const ROSE_PINE_THEME: MixCodeTheme = {
  ...
  searchMatchBg: persistentBgRgb("#c4a7e7"),
  searchMatchText: rgb("#ffffff"),
  scrollbarThumb: persistentBgRgb("#26233a"),
  thinkingText: rgb("#6e6a86"),
  thinkingMax: rgb("#eb6f92"),
