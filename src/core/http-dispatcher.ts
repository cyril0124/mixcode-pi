/**
 * HTTP dispatcher configuration for undici proxy and timeout support.
 *
 * This file is adapted from @earendil-works/pi-coding-agent v0.80.3
 * core/http-dispatcher.ts
 *
 * Original code: MIT License, Copyright (c) Mario Zechner
