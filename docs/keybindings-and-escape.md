...
| `Alt+Enter` | Input | Follow-up | Queue the editor draft when the agent is busy or follow-ups are paused; otherwise submit normally. See [queue management](queue-and-follow-up.md). |
