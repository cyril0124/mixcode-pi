...
| `mpi-bash` | Auto on bash spawn, `/bash-logs` | Default execution timeout, foreground window with auto-detach to the background, automatic completion notices, and a picker for reading a background command's full log. |
